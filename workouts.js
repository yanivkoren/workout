const WORKOUTS = [
    ...
    },
    {
      ...
      exercises: 
        ...
        nameEn: "Scapular Pull-Up / Depression",
        timeReps: "3×10–12 (החזקה 1–2ש׳ בתחתית)",
        instructions: "אחוז במתח ברוחב כתפיים–כתפיים וחצי; התחלה בתלייה מלאה, בטן אסופה וצוואר ניטרלי; בצע הורדה וקירוב שכמות בלבד ללא כיפוף מרפקים; דחוף “כתפיים לכיסים”, החזק 1–2ש׳ בסוף הטווח; חזור לאט לתלייה (שליטה אקצנטרית); הימנע מקפיצה/נדנוד, מכתפיים מורמות ומראש שמתקדם קדימה.",
        imageURL: "https://fitliferegime.com/wp-content/uploads/2022/12/How-To-Do-Scapular-Retraction-Pull-Ups.gif"
      },
                {
        muscle: "חזה אמצעי",
        nameHe: "לחיצת חזה שטוחה במוט",
        nameEn: "Flat Barbell Bench Press",
        timeReps: "3×12 (טמפו ירידה 2–3ש׳)",
        instructions: "שכיבה על ספסל, רגליים יציבות על הרצפה, קשת טבעית קלה בגב; כווץ שכמות לאחור ולמטה ושמור כך לאורך הסט; אחיזה מעט רחבה מרוחב כתפיים, שורש כף יד ניטרלי; הורד את המוט למרכז/תחתית החזה במסלול אלכסוני קטן; עצירה קצרה ללא ניתור, דחיפה מעלה עד כמעט נעילה; נהל נשימה (שאיפה בירידה, נשיפה בדחיפה); הימנע ממרפקים פתוחים מדי, מבאונס על החזה, מהרמת ישבן/רגליים. מומלץ ספוטר במשקלים כבדים.",
        imageURL: "https://fitnessprogramer.com/wp-content/uploads/2021/02/Barbell-Bench-Press.gif"
      },
                {
        muscle: "כתף אחורית",
        nameHe: "מכונת דק-פלאיי הפוך",
        nameEn: "Reverse Pec Deck",
        timeReps: "3×12 (2ש׳ ירידה/שליטה)",
        instructions: "שב עם חזה צמוד למשענת, מושב מכוון כך שהידיות בגובה כתף; אחוז בידיות, מרפקים כפופים קלות ונשארים בגובה כתף; פתח לאחור בקשת עד יישור קו עם הגוף, סחט שכמות/אחורי כתף והחזק 1ש׳; חזור קדימה באיטיות; שמור צוואר ניטרלי וכתפיים רחוקות מהאוזניים; הימנע מזריקת משקל, מתנועת יתר בשורש כף היד ומעלייה/ירידה של המרפקים.",
        imageURL: "https://www.inspireusafoundation.org/file/2022/10/reverse-pec-dec-machine.gif"
      },
                {
        muscle: "בייספס – ראש ארוך",
        nameHe: "כפיפת מרפקים ישיבה על שיפוע",
        nameEn: "Incline Dumbbell Curl",
        timeReps: "3×12 (ירידה איטית 3ש׳)",
        instructions: "ספסל בזווית 45–60°, גב צמוד; ידיים תלויות לאחור מעט (מתיחה לראש הארוך), כפות ידיים מסובבות קדימה; כופף מרפקים בלי להזיז כתפיים/להקדים מרפק; שמור סופינציה מלאה בעלייה וסחט בראש הטווח; הורד לאט עד יישור מרפק ומתח שריר; הימנע מנדנוד/קפיצה, ממרפקים שבורחים קדימה ומקריסת כתפיים; נשיפה בעלייה, שאיפה בירידה.",
        imageURL: "https://burnfit.io/wp-content/uploads/2023/11/INC_DB_CURL.gif"
      },
                {
        muscle: "טרייספס – ראש מדיאלי",
        nameHe: "פושדאון בקייבל באחיזה הפוכה",
        nameEn: "Reverse-Grip Cable Pushdown",
        timeReps: "3×12 (החזקה 1–2ש׳ בנעילה)",
        instructions: "עמידה יציבה מול כבל גבוה, מוט ישר/‏EZ, אחיזה הפוכה צרה-בינונית; כווץ שכמות קל, מרפקים צמודים לצידי הגוף (צירים קבועים); יישר מרפקים עד סוף טווח בלי “לפתוח כתפיים”, החזק 1–2ש׳; החזר לאט למעלה בשליטה; שמור שורש כף יד ניטרלי, ללא שבירת שורש; הימנע מהתכופפות/נדנוד גוף וממרפקים שמטיילים קדימה.",
        imageURL: "https://www.sparkpeople.com/assets/exercises/Reverse-Grip-Triceps-Pulldown-on-Cable-Cross-Machine.gif"
      },
                {
        muscle: "ייצוב כתף – Rotator Cuff",
        nameHe: "Cuban Press קל",
        nameEn: "Cuban Press – Light",
        timeReps: "2–3×12–15 (משקל קל, טמפו איטי)",
        instructions: "עמידה זקופה עם דאמבלים קלים; הרמה לצד עד ~90° → סיבוב חיצוני עד שאמות כמעט אנכיות → לחיצה קצרה/חצי טווח; חזור באותו סדר לאט; שמור שכמות לאחור/למטה, מרפקים מתחת לשורש כף היד בסיבוב; בצע בטווח שלא מכאיב, דגש שליטה ואיכות תנועה ולא עומס; הימנע משאיבת כתפיים למעלה ומהטיית גב; נשיפה במקטעי המאמץ.",
        imageURL: "https://bodybuilding-wizard.com/wp-content/uploads/2025/01/cuban-rotation-with-dumbbells.gif"
      },
        ],
    },
    {
